  ...
  public <N extends Notification> void send(N notification) {
    ...
    List<Runnable> runnableNotifications =
        notificationHandlers
            ...
            .map(
                it -> {
                  Notification.Middleware.Next handleNotification = new Notification.Middleware.Next() {
                    @Override
                    public Class<?> getBaseHandlerType() {
                      return it.getClass();
                    }
                  ...
                  return (Runnable)
                      () ->
                          notificationMiddlewares
                              ...
                              .foldRight(
                                  handleNotification,
                                  (step, next) -> new Notification.Middleware.Next() {
                                    @Override
                                    public Class<?> getBaseHandlerType() {
                                      return it.getClass();
                                    }
